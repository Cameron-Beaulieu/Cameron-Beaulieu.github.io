...
function ProjectStack(){
    return(
        <div id = "projectStack">
            ...
            <Project 
            banner = {swypeIcon} 
            video = {<iframe width="50%" height="500" src="https://www.youtube.com/embed/klGUyrtO-fk" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>}
            slideShow = {<iframe src="https://docs.google.com/presentation/d/e/2PACX-1vQiL6c_FEHcIYuBsI-ZJiWa6SMKzCqnRfGexPS0PdM0GdIgoxuOBVDdOm1nHzWLznk1Hj9yydmXu9y3/embed?start=false&loop=false&delayms=3000" frameborder="0" width="50%" height="500" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>}
            title = "Swype"
            ...
            <Project
            banner = {veilIcon}
            video = {<iframe width="50%" height="500" src="https://www.youtube.com/embed/igIYOyoMusU" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>}
            slideShow = {<iframe src="https://docs.google.com/presentation/d/e/2PACX-1vSEDARyx6fZZ2RhfyUOZnkLMVjiUVqXhaz2lspLo8qdZ-WbPpQxqNp3c8ILl6QkqtnuZKZ0RmFsD9Uh/embed?start=false&loop=false&delayms=3000" frameborder="0" width="50%" height="500" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>}
            title = "Veil"
